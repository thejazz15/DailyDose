...
public class TvShowDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_TABLE = "CREATE TABLE "+ TvShowsEntry.TABLE_NAME + " ("
                ...
                +TvShowsEntry.COLUMN_AIR_DATE+ " INTEGER NOT NULL, "
                ...
                +TvShowsEntry.COLUMN_IMG_URL_MEDIUM+ " TEXT, "
                +TvShowsEntry.COLUMN_IMG_URL_ORIGINAL+ " TEXT, "
        ...
        final String SQL_CREATE_FAVOURITES_TABLE = "CREATE TABLE " + FavsShowEntry.TABLE_NAME + " ("
                ...
                +FavsShowEntry.COLUMN_AIR_DATE + " INTEGER, "
                ...
                +FavsShowEntry.COLUMN_SHOW_SUMMARY+ " TEXT, "
                +FavsShowEntry.COLUMN_IMG_URL_MEDIUM+ " TEXT, "
                +FavsShowEntry.COLUMN_IMG_URL_ORIGINAL+ " TEXT, "
                +FavsShowEntry.COLUMN_IMDB_ID+ " TEXT, "
